...
GAMEWEEK_SCHEDULE = [
    ...
    # (29, datetime(2026, 1, 24), datetime(2026, 1, 24, 11, 00), datetime(2026, 1, 26, 20, 00)),
    # (30, datetime(2026, 1, 24), datetime(2026, 1, 24, 11, 00), datetime(2026, 1, 26, 20, 00)),
    # (31, datetime(2026, 1, 24), datetime(2026, 1, 24, 11, 00), datetime(2026, 1, 26, 20, 00)),
    # (32, datetime(2026, 1, 24), datetime(2026, 1, 24, 11, 00), datetime(2026, 1, 26, 20, 00)),
    # (33, datetime(2026, 1, 24), datetime(2026, 1, 24, 11, 00), datetime(2026, 1, 26, 20, 00)),
    # (34, datetime(2026, 1, 24), datetime(2026, 1, 24, 11, 00), datetime(2026, 1, 26, 20, 00)),
    # (35, datetime(2026, 1, 24), datetime(2026, 1, 24, 11, 00), datetime(2026, 1, 26, 20, 00)),
    # (36, datetime(2026, 1, 24), datetime(2026, 1, 24, 11, 00), datetime(2026, 1, 26, 20, 00)),
    # (37, datetime(2026, 1, 24), datetime(2026, 1, 24, 11, 00), datetime(2026, 1, 26, 20, 00)),
    # (38, datetime(2026, 1, 24), datetime(2026, 1, 24, 11, 00), datetime(2026, 1, 26, 20, 00)),
]
